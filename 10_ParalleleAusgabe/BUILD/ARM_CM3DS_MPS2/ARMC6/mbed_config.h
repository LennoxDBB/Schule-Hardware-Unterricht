...
#define MBED_CONF_SMSC9220_EMAC_RX_RING_LEN                                   1                                                                                                // set by library:smsc9220-emac
#define MBED_CONF_SMSC9220_EMAC_TX_RING_LEN                                   1                                                                                                // set by library:smsc9220-emac
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       ETHERNET                                                                                         // set by target:ARM_CM3DS_MPS2
